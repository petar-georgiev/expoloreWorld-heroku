...
@WithMockUser("pesho@pesho.com")
@SpringBootTest
@AutoConfigureMockMvc
class CommentRestControllerTest {

    private static final String COMMENT_1 = "Super route";
    private static final String COMMENT_2 = "Ehaa" ;
    ...
    void setUp() {
        ...
        testUser.setEmail("pesho@pesho.com");
